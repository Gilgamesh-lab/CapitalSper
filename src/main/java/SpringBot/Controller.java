...
public class Controller {
    ...
    public List<Integer> getPersonnages() {
        return Referentiel.getIdPersonnageDisponible();
    }

    @GetMapping("/lancerUnePartie")
    public ResponseEntity  createUser(@RequestBody Partie partie) {
		...
		return ResponseEntity.status(HttpStatus.OK).body(logger.getLogPartie());
